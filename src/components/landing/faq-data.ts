...
export const faqData: FAQItemData[] = [
  ...
  },
  {
    ...
    answer:
      "Yes! You don't need to manually bridge funds. Olympus integrates Chainlink CCIP (Cross-Chain Interoperability Protocol). You can simply send USDC from supported chains and our protocol will automatically \"zap\" your funds into the Olympus Vault on Polkadot Hub TestNet in a single transaction. It's seamless and hassle-free.",
  },
];
