...
export default function Home() {
  ...
  return (
    <div ref={containerRef} className="bg-[#e0e0e0] overflow-x-hidden">
      ...
      {/* Section 3 - FAQ and Footer */}
      <section className="min-h-screen relative flex flex-col bg-[#e0e0e0]">
        {/* FAQ Content */}
        <div className="flex-1 px-6 sm:px-8 lg:px-11 py-12 lg:py-20">
      ...
      >
        ...
        >
          <span className="font-syne font-medium text-white text-xl px-2">
            APOLLOS FINANCE • BOOSTED POOLS • ORACLE PRICING • LVR SHIELD • APOLLOS FINANCE •
            BOOSTED POOLS • ORACLE PRICING • LVR SHIELD • APOLLOS FINANCE • BOOSTED POOLS • ORACLE PRICING • LVR SHIELD • APOLLOS FINANCE • BOOSTED POOLS • ORACLE PRICING • LVR SHIELD • APOLLOS
            FINANCE • BOOSTED POOLS • ORACLE PRICING • LVR SHIELD • APOLLOS FINANCE • BOOSTED POOLS • ORACLE PRICING • LVR SHIELD •
          </span>
          <span className="font-syne font-medium text-white text-xl px-2">
            APOLLOS FINANCE • BOOSTED POOLS • ORACLE PRICING • LVR SHIELD • APOLLOS FINANCE •
            BOOSTED POOLS • ORACLE PRICING • LVR SHIELD • APOLLOS FINANCE • BOOSTED POOLS • ORACLE PRICING • LVR SHIELD • APOLLOS FINANCE • BOOSTED POOLS • ORACLE PRICING • LVR SHIELD • APOLLOS
