...
description: Seven-workflow CRE blueprint as the Central Nervous System of Olympus Finance.
---
...
Olympus Finance is not a static DeFi protocol that waits for user interaction.  
With Chainlink CRE (Chainlink Runtime Environment), Olympus operates as a 24/7 autonomous system with seven parallel workflows designed to:
...
This architecture functions as the **Central Nervous System** of Olympus.
...
4. Chainwrite path:
   - Forwarder (source chain) -> GenericWorkflowReceiver -> `SourceRouter.bridgeToPolkadotHub(...)`.
5. CCIP delivery:
