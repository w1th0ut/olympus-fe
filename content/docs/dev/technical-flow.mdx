...
description: System architecture, core concepts, contract architecture, and math foundation of Olympus.
---

# Technical Flow

This page explains how Olympus works from architecture, protocol design, contracts, and math.

## 🛠️System Architecture

Olympus is designed as a layered system:
...
- Backend & Report Layer (`olympus-be`)
  - Receive report from Chainlink Runtime Environment.
  - Set AI Guardian logs for Olympus Frontend.
- Chainlink CRE Layer (`olympus-cre`)
  - Workflow-based automation model for modular role execution.
  - Each workflow roles can be simulated independently.
